package com.akatsuki.nes.framework.ui.multitouchbutton;
...
public class MultitouchTwoButton extends MultitouchImageButton {
    ...
    public MultitouchTwoButton(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    public MultitouchTwoButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
